...
public class TestParser {
    public static void main(String[] args) {
        if (args.length == 0) {
            ...
            System.err.println("Default output: GeneratedTests.java");
            return;
        }
        ...
        try {
            ...
            if (result != null && result.value != null) {
                ...
                System.out.println("\nNext steps:");
                System.out.println("  1. Compile: javac -cp .;junit-platform-console-standalone.jar " + outputFile);
                System.out.println("  2. Run: java -jar junit-platform-console-standalone.jar --class-path . --scan-classpath");
